        ...
        public static void SeedDatabase(ApplicationDbContext context) {            
            if (context.Database.GetMigrations().Count() > 0 && context.Database.GetPendingMigrations().Count() == 0) {
                ...
                if (context.NameCategories.Count() == 0) {
                    ...
                    "Adamah", "Adar", "Adbeel", "Addar", "Addi", "Addin", "Addon", "Adiel", "Adin", "Adina", "Adithaim", "Adlai", "Admah", "Admatha", "Admin", "Adna", 
                    "Adnah", "Adoni", "Adonibezek", "Adonijah", "Adonikam", "Adoniram", "Adoraim", "Adoram", "Adrammelech", "Adramyttium", "Adria", "Adriel", "Aduel", "Adullam",
                     ...
                     "Amittai", "Ammah", "Ammi", "Ammiel", "Ammihud", "Amminadab", "Ammishaddai", "Ammizabad", "Ammon", "Amnon", "Amok", "Amon", "Amorite", "Amoz", 
                     "Amplias", "Amram", "Amraphel", "Amzi", "Anab", "Anah", "Anaharath", "Anaiah", "Anak", "Anamim", "Anammelech", "Anani", "Ananias", "Anathema", "Anathoth", 
                     "Andrew", "Andronicus", "Anem", "Aner", "Aniam", "Anim", "Anna", "Annas", "Antichrist", "Antipas", "Antipatris", "Antothijah", "Anub", "Apelles",
                     ...
                     "Azmaveth", "Babel", "Babylon", "Baca", "Bachuth", "Bahurim", "Bajith", "Bakbakkar", "Bakbukiah", "Baladan", "Balak", "Ball", "Balaam", "Bamah", 
                     ...
                     "Beelzebub", "Beer", "Beera", "Beerelim", "Beeri", "Beeroth", "Beersheba", "Behemoth", "Bekah", "Belah", "Belial", "Belshazzar", "Belteshazzar", 
                     ...
                     "Coniah", "Coos", "Corinth", "Cosam", "Coz", "Crescens", "Crete", "Crispus", "Cumi", "Cush", "Cushan", "Cuth", "Cyprus", "Cyrene", "Cyrenius", 
                     ...
                     "Dedanim", "Dekar", "Delaiah", "Delilah", "Demas", "Demetrius", "Derbe", "Deuel", "Deuteronomy", "Diblah", "Diblaim", "Diblath", "Diblathaim", 
                     ...
                     "Eutychus", "Eva", "Eve", "Evi", "Evil", "Exodus", "Ezal", "Ezbon", "Ezekiel", "Ezel", "Ezem", "ezer", "Ezion", "Ezra", "Felix", "Festus", 
                     ...
                     "Gispa", "Gittah", "Gittaim", "Gittites", "Goath", "Gob", "Gog", "Golan", "Golgotha", "Goliat", "Goliath", "Gomer", "Gomorrah", "Goshen", "Gozan", "Gudgodah",
                      ...
                      "Hadadrimmon", "Hadar", "Hadarezer", "Hadashah", "Hadassah", "Hadattah", "Haddah", "Haddon", "Hadlai", "Hadoram", "Hadrach", "Hagab", "Hagabah", 
                      ...
                      "Hamor", "Hamul", "Hamutal", "Hanameel", "Hanan", "Hananeel", "Hanani", "Hananiah", "Hanes", "Haniel", "Hannathon", "Hanniel", "Hanoch", "Hans", 
                      ...
                      "Iim", "Ije-abarim", "Ijon", "Ikkesh", "Ilai", "Illyricum", "Imla", "Imlah", "Immanuel", "Immer", "Imna", "Imnah", "Imrah", "Imri", "India", 
                      ...
                      "Jahzeel", "Jahzerah", "Jair", "Jairus", "Jakan", "Jakeh", "Jakim", "Jakob", "Jalon", "Jambres", "Jamin", "Jamlech", "Janna", "Janoah", "Janum", 
                      ...
                      "Joelah", "Joezer", "Jogbehah", "Jogli", "Joha", "Johanan", "Johanna", "Johannes", "Joiarib", "Jokdeam", "Jokim", "Jokmeam", "Jokneam", "Jokshan", 
                      ...
                      "Libya", "Likhi", "Lilith", "Lior", "Lo", "Lod", "Lois", "Lot", "Lubin", "Lucas", "Lucifer", "Lud", "Luhith", "Lukas", "Luz", "Lycaonia", 
                      ...
                      "Nain", "Naioth", "Naphish", "Naphtali", "Narcissus", "Nathan", "Nathanael", "Naum", "Nazareth", "Nazarite", "Neah", "Neapolis", "Neariah", "Nebai", 
                      "Nebaioth", "Neballat", "Nebat", "Nebo", "Nebuchadnezzar", "Nebuzaradan", "Necho", "Nedabiah", "Nehelamite", "Nehemiah", "Nehum", "Nehushta", "Nehushtan", 
                      "Neiel", "Nekoda", "Nemuel", "Nepheg", "Nephilim", "Nephish", "Nephishesim", "Nephthalim", "Nephtoah", "Nephusim", "Ner", "Nergal", "Neri", "Neriah", 
                      "Nethaneel", "Nethaniah", "Nethinim", "Neziah", "Nezib", "Nibhaz", "Nibshan", "Nicanor", "Nicodemus", "Nicolaitanes", "Nicopolis", "Niger", "Nimrah",
                      ...
                      "Peresh", "Perez", "Perga", "Pergamos", "Perida", "Perizzites", "Persia", "Persis", "Peruda", "Pethahiah", "Pethuel", "Peulthai", "Phalec", "Phallu", 
                      ...
                      "Piram", "Pirathon", "Pisgah", "Pishon", "Pisidia", "Pison", "Pithom", "Pithon", "Pochereth", "Pontius", "Poratha", "Potiphar", "Potipherah", "Prisca", 
                      ...
                      "Rosh", "Ruhamah", "Rumah", "Ruth", "Raamah", "Raamiah", "Sabaeans", "Sabaoth", "Sabtah", "Sabtechah", "Sacar", "Sachia", "Sadducees", "Sadoc", 
                      "Sahadutha", "Sakia", "Salah", "Salathiel", "Salcah", "Salem", "Salim", "Sallai", "Salma", "Salmon", "Salome", "Samaria", "Samlah", "Samos", 
                      ...
                      "Seir", "Selah", "Seled", "Seleucia", "Sem", "Semachiah", "Semei", "Seneh", "Senir", "Sennacherib", "Senaah", "Seorim", "Sephar", "Sepharad", "Sepharvaim",
                      ...
                      "Shaaraim", "Shaashgaz", "Sia", "Sibbechai", "Sibmah", "Sichem", "Siddim", "Sidon", "Sigionoth", "Sihon", "Sihor", "Silas", "Silla", "Siloa", "Simeon", 
                      ...
                      "Theophilus", "Thessalonica", "Theudas", "Thuhash", "Thummim", "Thyatira", "Tibbath", "Tiberias", "Tiberius", "Tibni", "Tidal", "Tiglath", "Tikvah", 
                      ...
                      "Zaccur", "Zachariah", "Zacher", "Zadok", "Zaham", "Zair", "Zalaph", "Zalmon", "Zalmonah", "Zalmunna", "Zamzummims", "Zanoah", "Zaphnath", "Zarah", 
                    ...
                    "Cyia", "Damar", "Daniels", "Data", "Dax", "Deanna", "Degra", "Detmer", "Dolim", "Dukat", "Eddington", "Edon", "Ehleyr", "Elanna", "Garak", "Elnor", 
                    "Enabran", "Erika", "Evek", "Ezri", "Fontaine", "Forge", "Forrest", "Garrison", "Gen", "Geordi", "Georgiou", "Gomez", 
                    "Gowron", "Grayson", "Guinan", "Hayes", "Hernandez", "Hikaru", "Hogan", "Homn", "Hoshi", "Hugh", "Icheb", "Ishka", "Jadzia", "Jal", "Janeway", 
                    "Janice", "Jannar", "Jean", "Jennifer", "Jet", "Joann", "José", "Julian", "Jurati", "Kashimuro", "Kasidy", "Katherine", "Kathryn", 
                    "Katrina", "Keiko", "Kes", "Keyla", "Khan", "Kim", "Kimara", "Kira", "Kirk", "Kol", "Kor", "Kurn", "La", "Laren", "Laris", "Leeta", "Lefler", "Leland", 
                    "Leonard", "Li Nalas", "Linus", "Lon", "Lorca", "Lore", "Luc", "Lursa", "Lwaxana", "Maihar", "Malcolm", "Mallora", "Mariner", "Martok", "Maxwell", 
                    "Mayweather", "McCoy", "Mezoti", "Mila", "Miles", "Montgomery", "Mora", "Morn", "Mot", "Mudd", "Musiker", "Naomi", "Narek", "Narissa", "Nechayev", 
                    "Neelix", "Nerys", "Nhan", "Nicoletti", "Nilsson", "Nog", "Noonien", "Nozawa", "Nyota", "Odo", "Ogawa", "Oh", "Opaka", "Owosekun", "Pavel", 
                    "Philippa", "Phillip", "Phlox", "Picard", "Pike", "Pol", "Pollard", "Pulaski", "Quark", "Raffi", "Rand", "Rebi", "Reed", "Rell", "Renee", "Reno", 
                    "Rhys", "Riker", "Rios", "Rizzo", "Ro", "Robin", "Ross", "Rostov", "Rozhenko", "Saavik", "Samantha", "Sarek", "Saru", "Sato", "Scott", "Sela", "Seska", 
                    "Shakaar", "Shran", "Silik", "Singh", "Sisko", "Sloan", "Soji", "Sonya", "Soval", "Spock", "Stamets", "Suder", "Sulan", "Sulu", "Sylvia", "Tain", 
                    ...
                    "Bones", "Boot", "Brown", "Buckbeak", "Bulstrode", "Burbage", "Cadmus", "Carrow", "Cattermole", "Cedric", "Chang", "Charity", "Charlie", "Cho", 
                    ...
                    "Greyback", "Grindelwald", "Griphook", "Griselda", "Grubbly-Plank", "Gryffindor", "Hagrid", "Hannah", "Harry", "Hedwig", "Hermione", 
                    "Hokey", "Hooch", "Hopkirk", "Horace", "Hufflepuff", "Hugo", "Ignotus", "Igor", "Irma", "James", "John", "Jordan", "Jorkins", "Justin", 
                    "Karkaroff", "Katie", "Kendra", "Kettleburn", "Kingsley", "Kreacher", "Krum", "Lavender", "Lee", "Lestrange", "Lily", "Lockhart", "Longbottom", "Lovegood", 
                    "Lucius", "Ludo", "Luna", "Lupin", "Macmillan", "Macnair", "Madam", "Rosmerta", "Mafalda", "Magorian", "Malfoy", "Malkin", "Marchbanks", "Marge", 
                    "Marietta", "Marvolo", "Maxime", "McGonagall", "McLaggen", "Merope", "Midgen", "Millicent", "Minerva", "Moaning", "Molly", "Montague", "Moody", 
                    "Morfin", "Mundungus", "Myrtle", "Nagini", "Narcissa", "Neville", "Newt", "Nick", "Nicolas", "Nigellus", "Norbert", "Nott", "Nymphadora", "Ogden",
                    "Oliver", "Ollivander", "Olympe", "Padma", "Pansy", "Parkinson", "Parvati", "Patil", "Peeves", "Penelope", "Percival", "Percy", "Pettigrew", 
                    "Petunia", "Peverell", "Phineas", "Pigwidgeon", "Pince", "Pius", "Podmore", "Pomfrey", "Pomona", "Poppy", "Potter", "Quirinus", "Quirrell", "Ravenclaw", 
                    "Reginald", "Remus", "Riddle", "Rita", "Robins", "Rolanda", "Romilda", "Ron", "Ronan", "Rookwood", "Rowena", "Rowle", "Rubeus", "Rufus", "Runcorn", 
                    "Salazar", "Scabbers", "Scabior", "Scamander", "Scorpius", "Scrimgeour", "Seamus", "Septima", "Severus", "Shacklebolt", "Shunpike", "Silvanus", "Sinistra", 
                    "Cadogan", "Sirius", "Skeeter", "Slughorn", "Slytherin", "Smith", "Snape", "Spinnet", "Sprout", "Stan", "Sturgis", "Susan", "Sybill", "Ted", "Terry", 
                    "Theodore", "Thicknesse", "Thomas", "Thorfinn", "Tonks", "Travers", "Trelawney", "Trevor", "Twycross", "Umbridge", "Vance", "Vane", 
                    ...
                    "Atena", "Atene", "Athena", "Athene", "Atlas", "Atreus", "Autolykos", "Bacchus", "Bellerophontes", "Briseis", "Brises", "Castor", "Cerberus", "Ceres",
                    ...
                    "Eurypylos", "Fama", "Faunus", "Fønix", "Gaea", "Gaia", "Glaukos", "Gorgythion", "Hades", "Hebe", "Hecate", "Hector", "Hekabe", "Hektor", "Helena", 
                    ...
                    "Laertes", "Lampetia", "Laodameia", "Laodike", "Laomedon", "Lavinia", "Leda", "Lelantos", "Leto", "Lokris", "Lykaon", "Lyrnessos", "Maia", "Mars", 
                    "Medesikaste", "Megara", "Meges", "Melanthios", "Menelaos", "Menoetius", "Menoitios", "Mentor", "Mercury", "Meriones", "Merkur", "Metis", "Minos", 
                    "Mnemosyne", "Molos", "Muse", "Mynes", "Nausikaa", "Nausithoos", "Neleus", "Nemesis", "Neoptolemos", "Neptun", "Nereider", "Nereus", "Nesoi", "Nestor", "Nodotus",
                    "Nyx", "Oceanus", "Odysseus", "Ogygia", "Oileus", "Oineus", "Okeanos", "Olymp", "Olympia", "Ops", "Orenos", "Orestes", "Orion", "Orsilochos", "Otos", 
                    "Ourea", "Pallas", "Panthoos", "Patellana", "Patroclos", "Patroklos", "Peirithoos", "Peisistratos", "Peleion", "Peleus", "Pelias", "Penelopeia", 
                    ...
                    "Polypheides", "Polyphemos", "Polypoites", "Pontos", "Pontus", "Poseidon", "Priamos", "Prometheus", "Proserpina", "Pylos", "Rexenor", "Rhea", 
                    ...
                    "Fjalar", "Foresti", "Frej", "Freja", "Frey", "Freya", "Frig", "Frigg", "Frigga", "Fulla", "Garm", "Geirod", "Gejfun", "Grid", "Groa",  
                    "Hagbard", "Harbor", "Heidrun", "Heimdal", "Heimdall", "Hel", "Hermod", "Hermodr", "Hildr", "Hler", "Hlin", "Hoenir", "Høner", "Hoor", "Hreidmar", 
                    "Hrungnir", "Hugi", "Idun", "Idunn", "Joro", "Kvasir", "Laga", "Lofn", "Loke", "Loki", "Lounn", "Magne", "Magni", "Mani", "Mimer", "Mimir", "Modi", 
                    "Nerthus", "Njord", "Odin", "Orvar", "Othin", "Ran", "Rindr", "Sif", "Signy", "Sigrun", "Sigyn", 
                    "Sindre", "Sindri", "Siv", "Sjofn", "Skadi", "Snotra", "Svanhild", "Syn", "Thor", "Tiki", "Tor", "Tyr", "Ull", "Urd", "Vali", "Var", "Ve", 
                    ...
                    "Arnfast", "Arv ", "Asa", "Asbjørn", "Åse", "Asger", "Asgrim", "Aslak", "Aslaug", "Asmund", "Astrid", "Bergljot", "Birger", "Bjarke", "Bjarne", 
                    "Bjørg", "Björk", "Bjørk", "Brune", "Brynhilde", "Bue", "Dagfinn", "Ebbe", "Eglin", "Eilif", "Einar", "Einer", "Eivind", "Ejvind", "Ellida", "Erik", 
                    "Erland", "Eske", "Eskil", "Eskild", "Estrid", "Fenge", "Find", "Finn", "Folke", "Frida", "Frode", "Fryd", "Fylla", "Gerd", 
                    ...
                    "Hjalte", "Holger", "Holmfrid", "Horik", "Høskul", "Høskuld", "Hulda", "Ida", "Ide", "Inge", "Ingeborg", "Ingegerd", "Ingolf", "Ingvar", "Ivar", 
                    ...
                    "Ashton", "Aston", "Ayrton", "Barrington", "Benson", "Bentley", "Berton", "Bibson", "Bradley", "Brenton", "Britton", "Bryson", 
                    "Carlson", "Carlton", "Carrington", "Carton", "Chayton", "Clayson", "Clayton", "Clinton", "Dalton", "Davinson", "Dickson", "Driton", 
                    "Easton", "Edison", "Edson", "Elton", "Emerson", "Eton", "Faton", "Greyson", "Hadley", "Hamilton", "Harrison", "Helton", "Hilton", 
                    "Hudson", "Huntley", "Huxley", "Jackson", "Jayson", "Jeferson", "Jefferson", "Jeton", "Johnson", "Jones", "Karlanton", "Karlton", "Keaton", "Kenton", 
                    "Kleton", "Leighton", "Lesley", "Leyton", "Lindley", "Linton", "Maddison", "Madison", "Mailey", "Manley", "Marley", "Mason", 
                    "Meriton", "Milton", "Morton", "Maarlley", "Naton", "Nelson", "Newton", "Norton", "Oakley", "Orson", "Paisley", "Paxton", "Payton", "Peyton", "Presley", 
                    "Printon", "Quinton", "Rasmusbailey", "Rickson", "Riley", "Ripley", "Robinson", "Rockson", "Ronson", "Royston", "Ryley", "Seeley", "Shelley", 
                    "Sheridan", "Soley", "Souley", "Stanley", "Sutton", "Tilley", "Triston", "Triton", "Tyson", "Valley", "Valton", "Vilton", "Vinston", "Waley", "Washington", 
                    "Weston", "Wiley", "Willey", "Wilson", "Wilton", "Winston" };
